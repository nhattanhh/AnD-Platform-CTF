...
import { Trophy, Swords, Shield, Clock, Wifi, WifiOff } from "lucide-react"
...
import { useScoreboardGames } from "@/hooks/use-scoreboard"
...
export default function ScoreboardPage() {
  ...
  const { scoreboard, isLoading, isConnected, refresh: refreshScoreboard } = useScoreboardWS(selectedGameId, {
